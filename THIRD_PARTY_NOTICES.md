...
The active CodeRocket UI packages and public documentation are licensed under the root [MIT license](LICENSE). The repository author is Alexandre Le Corre (`elreco`).
