---
title: "Dialog"
description: "A modal dialog with focus management, keyboard dismissal and a labelled title."
---

<DocPreview framework="vue" slug="dialog" kind="component"/>
...
<template>
  <Dialog trigger="Open dialog" title="Workspace settings" description="Manage the details of your workspace."><Input aria-label="Workspace name" placeholder="Acme" /></Dialog>
</template>
