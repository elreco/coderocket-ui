...
<DocPreview framework="vue" slug="radio-group" kind="component"/>
...
<template>
  <RadioGroup label="Plan" default-value="personal" :options="[{ value: 'personal', label: 'Personal' }, { value: 'team', label: 'Team' }]" />
</template>
